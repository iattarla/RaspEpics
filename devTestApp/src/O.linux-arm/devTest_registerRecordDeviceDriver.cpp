...
/* Generated from ../O.Common/devTest.dbd */
...
int devTest_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/pi/epicsApps/devTest";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"devTest_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    devTest_registerRecordDeviceDriver(*iocshPpdbbase);
}
